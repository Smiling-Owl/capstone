<!-- converted from 072826-fullpaper.docx -->
...
# INTRODUCTION
## Project Context
The Zamboanga City Disaster Risk Reduction Management Office (ZCDRRMO) is the primary institutional body mandated to lead, coordinate, and institutionalize disaster risk reduction and management efforts in the city of Zamboanga. The office was established pursuant to the Republic Act No. 10121 otherwise known as “The Philippine Disaster Reduction and Management Act of 2010”, dated in May 27, 2010 and designating the members thereof as well as the City Ordinance No. 433 series 2016 (Office of the City Disaster Risk Deduction Management | Zamboanga Website, n.d.). This caused a shift in the country’s disaster management paradigm from purely reactive emergency response to a proactive, risk-reduction and resilience-building approach. The office operationalizes national disaster risk reduction management policies at a local scope, ensuring that the strategies are placed and contextualized to the city’s environmental and socio-economic conditions.
Guided by its vision of “Safer, adaptive and disaster resilient Zamboangueño
communities towards sustainable development”, the ZCDRRMO guides the city to its vision of anticipatory and adaptive resilience. The organization’s vision reflects a commitment to safeguarding lives, protecting the environment, strengthening institutional and local capacities, and ensuring that development gains are not simply swept by disaster.
The mission of the ZCDRRMO, according to the Office of the City Disaster Risk
Deduction Management | Zamboanga Website (n.d.), is rooted on five major pillars that are based on the four DRRM thematic areas: Disaster  Prevention and Mitigation, Disaster Preparedness, Disaster Response, Disaster Rehabilitation and Recovery, and Public Safety. In Disaster Prevention and Mitigation, the office seeks to avoid hazards and reduce their potential impacts by reducing vulnerabilities and exposure and enhancing capabilities of the communities. In Disaster Preparedness, the office aims to establish and strengthen capacities of communities to anticipate, cope, and recover from the negative impacts of the emergency occurrences and disasters. Under Disaster Response, it ensures life preservation and meets the basic subsistence needs of affected populations based on acceptable standards during or immediately after a disaster. Under Disaster Rehabilitation and Recovery, the office restores and improves facilities and living conditions and capacities of affected communities and reduces risks in accordance with the “building back better” principle. Complementing the four DRRM thematic areas the city is compliant to is Public Safety mandate, which aims to maintain peace and order, to prevent and suppress lawlessness, disorder, riot, violence, rebellion, or sedition for the generate welfare and its habitants. Crucial to this initiative is the development of a Command Center System (C2) and Incident Response Management System (IRMS) to enhance real-time monitoring, coordination, and interagency response capabilities.
To effectively deliver its mandate, the ZCDRRMO is organizationally structured into three major departments: Administration and Training, Research and Planning, and Operations and Warning Staff.
The administration and training department is responsible for the provision of administrative and capacity-building services. This division organizes and conducts training, orientation, and knowledge management activities on Disaster Risk Reduction and Management and Public Safety (DRRMPS) at the local level, including the barangays. It identifies, assesses, and manages hazards, vulnerabilities, and risks within the locality and implements cost effective risk reduction measures and strategies. The division disseminates information and raises public awareness about hazards and risk mitigation while ensuring compliance with RA 10121 and other relevant legislative provisions. It takes continuous steps to maintain and provide suitably trained and competent personnel for effective civil defense and DRRMPS implement in the city. Furthermore, it organizes, trains, equips, and supervises local emergency response teams and Accredited Community Disaster Volunteers (ACDVs), ensuring that humanitarian aid workers are prepared for deployment. Special emphasis is placed on training barangays and the most vulnerable sectors such as women, children, senior citizens, and persons with disabilities (PWDs), particularly in disaster preparedness and risk reduction initiatives. It also implements policies and approves plans and programs of the Local Disaster Risk Reduction and Management Council (LDRRMC) consistent with national guidelines.
The Research and Planning Division serves as the strategic and policy development arm of the office. It designs programs and coordinates DRRM activities consistent with national standards and guidelines. The division consolidates local disaster risk information, including data on natural hazards, vulnerabilities, and climate change risks, and maintains an updated local risk map. It conducts research and development initiatives on DRRM and Climate Change Adaptation (CCA), while maintaining comprehensive databases of human resources, equipment inventories, directories, and the locations of critical infrastructures such as hospitals and evacuation centers. Acting as the Secretariat and executive arm of the LDRRMC, the division recommends the enactment of local ordinances consistent with RA 10121 and facilitates risk assessments and contingency planning at the local level. It formulates and implements a comprehensive and integrated local DRRM plan aligned with national, regional, and provincial frameworks in close coordination with Local Development Council (LDC). Additionally, it prepares and submits the annual LDRRMPSO Plan and Budget, including the programming of the Local Disaster Risk Reduction and Management Fund (LDRRMF), and ensures transparency by submitting utilization reports to the Commission on Audit (COA), the Office of Civil Defense (OCD), and the Department of the Interior and Local Government (DILG). The division actively involves barangays and vulnerable sectors in risk assessment, vulnerability analysis, and planning processes to promote inclusive and participatory governance.
The Operations and Warning Staff constitutes the frontline emergency response
and monitoring unit of the ZCDRRMO. It operates a multi-hazard early warning system linked to disaster risk reduction mechanisms, providing accurate and timely advisories to national and local emergency response organisations and the general public through diverse communication platforms, including radio, landline systems, and community-based technologies. The division manages and responds to the adverse effects of emergencies, ensuring efficient delivery of food, shelter, and medical supplies, particularly for women and children. It endeavors to create safe and supportive spaces for internally displaced mothers, offering assistance in breastfeeding, infant care, and peer support. The division establishes and maintains DRRM Operations Centers at the provincial, city, municipal, and barangay levels and continuously monitors disaster situations. It mobilizes instrumentalities of the LGU, civil society organizations (CSOs), private groups, and organized volunteers to utilize their facilities and resources for life and property protection during emergencies. Furthermore, it strengthens partnerships and networks with other LGUs, private sector entities, and volunteer organizations to enhance coordinated disaster response and recovery efforts. Special attention is consistently given to the needs of vulnerable sectors, ensuring inclusive and equitable emergency management.
Figure 1.1.1 ZCDRRMO Departments Profile
A Situation Report is a government, Nation Disaster Risk Reduction Management Office mandated report that is to be done by the different DRRMC offices across all the regions of the country when a disaster occurs. Private contents of the Situation Report is kept confidential to protect the privacy of the affected population while rudimentary information and data are publicized.
...
## Objectives
### General Objective
This research project aims to develop a Barangay Disaster Situation Reports Record Management and Generation System for the Zamboanga City Disaster Risk Reduction Management Office.
### Specific Objectives
To develop a User Management for the ZCDRRMO to ensure sensitive information like Personal Identifiable Information (PII, e.g., Full Name) are kept confidential from unauthorized access, ensure and establish authority to information hierarchy, and to limit access only to authorized personnel like Purok Leaders or equivalent representatives, Barangay Officials (e.g., Barangay Captain, Barangay DRRMC Chair), and ZCDRRMO personnel.
To develop a Disaster Reporting Module that will allow Purok Leaders to notify the Barangay Captain or BDRRMC Chair of an alarming disaster like high flood levels that needs immediate attention. Also, to allow the Barangay Captains/BDRRMC Chair to submit an initial report to the ZCDRRMO Operations Department.
To develop a Disaster Report Verification Module that will allow for organized verification of disaster incident reports by the ZCDRRMO personnels.
To develop a SitRep Generation Module where reports are constantly updated automatically based on the entry from the barangay/s and upon verification and confirmation of the ZCDRRMO verification personnel-assigned.
To develop a SitRep Catalog Module that will store and chronologically categorize the Situation Reports according to disasters. This allows the related ZCDRRMO departments like the Research and Planning to quickly access and search for a specific report.
To develop a Dashboard Module that will display relevant summaries regarding SitRep and allows ZCDRRMO personnels to read and filter analytics of Disaster Situation Reports.
...
The development of the Barangay Disaster Situation Reports Record Management and Generation System for the Zamboanga City Disaster Risk Reduction Management Office serves as a critical technological intervention in the localized disaster response framework of the city of Zamboanga. The significance of the study heavily impacted and manifested in different sectors and dimensions.
First, the system smoothens the process of disaster response. By transitioning from manual, verbal, or unverified social media message reporting to a structured Disaster Reporting Module, the office is now able to gain real-time, high-fidelity overview of the emergencies and plan their respective responses. The Geotagging and Report Verification features mitigate the risk of inaccurate and less precise results. This helps in ensuring that the assets and resources put for such emergencies are deployed precisely. All of the mentioned benefits would be incredibly helpful for the ZCDRRMO Operations and Warning division.
Next would be the benefits that would be felt in the Barangay Level. The system provides a formal platform for accountability and transparency. It professionalizes the flow of data from the Barangay Level to the ZCDRRMO. It ensures that the localized threats and incidents are elevated to the awareness of the city-level timely by enforcing a streamlined process as opposed to the current manual process.
The system will also benefit the Research and Planning division of the ZCDRRMO. It transforms raw emergency data into actual information that could be utilized for intelligence. This allows for evidence-based decision making and policy making as well as hazard mapping. By maintaining a searchable database of situation reports
Moreover, the project as a whole will be beneficial to the future researchers in their research endeavors. The project may provide key insights in their field of study and may use this as a reference in the future to help them enrich their study and in cases of reviewing related literature. Furthermore, this research project may spark a drive in technological advancements as technologies continue to evolve and the need for cutting-edge technologies continue to increase in the modern times.
